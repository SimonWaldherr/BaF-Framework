...
/*jshint sub: true, evil: true, boss:true, browser: true, indent: 2, white: true */
/*globals window */
...
var fdSlider = (function () {
  ...
  function getAttribute (elem, att) {
  ...
  function getInputAttributes (inp) {
    return {
  ...
  function destroySingleSlider (id) {
